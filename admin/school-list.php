    ...
    <main class="main-content">
        ...
        <div class="wrapper">
            ...
            <div class="page-header m-0">
                <h3 class="page-title mb-6 my-4 ml-4">Schools</h3>
                ...
                <div class="border-gray-200 dark:border-gray-700">
                    <ul class="flex flex-wrap -mb-px text-sm font-medium text-center dark:text-gray-400">
                        ...
                        <li class="mr-2">
                            <a href="add-school.php" class="inline-flex align-items-center gap-2 p-4 rounded-t-lg hover:text-gray-600 hover:border-gray-300 dark:hover:text-gray-300 group">
                                <span>
